...
class TimeValueSeries:
    ...
    def __init__(self,name,series=None, weight=1.0):
        '''Initialize the name and weight(in context of a Portfolio, default is 1) of a new TimeValueSeries'''
        self.name=name
        self.series=series

    def read_csv_adj_close(self):
        """Method reads series from collected/csv ands gets adj I thing is redundant
        wiil drop in the near if read_csv would suffice """
